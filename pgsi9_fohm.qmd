...
::: {.callout-note appearance="simple"}
Analyserade som separata delskalor fungerar item fit väl för båda faktorerna i Swelogs-data. **Korrelation** mellan faktorerna: *r* = 0.51.
:::
