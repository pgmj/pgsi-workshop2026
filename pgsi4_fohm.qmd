...
PGSI-4 = de fyra första frågorna i PGSI-9. Används i **HLV** för att mäta viss risk för spelproblem (1–2 poäng) respektive problemspelande (3+ poäng).
...
- Item 4 har problem med flera kategorier och behöver **dikotomiseras**
...
:::: {.columns}
::: {.column width="60%"}
![](images/fig22_swelogs_pgsi4_dif_alder.png){fig-alt="Tröskelvärden per item för åldersgrupper under respektive över 42 år i Swelogs. Den lägsta tröskeln för item 1-3 skiljer sig med 0.55-0.65 logits mellan grupperna."}
:::
...
- I HLV störst avvikelser för gruppen 81+ (få respondenter)
...
- Lägst just där screeninggränserna ligger (1–3 poäng)
- Fyra item med få fungerande svarströsklar ger helt enkelt begränsad information
:::
::::
...
- **Item 9**: fungerar **helt utan anmärkning** med item 1–3, har ännu lägre tröskelvärde — och dessutom en extra fungerande svarströskel
- Båda centrerar måttet på den **lägre delen av den latenta skalan**, där screening behöver information
- Att använda *både* item 5 och 9 tillsammans med item 1–3 skapar däremot nya problem (overfit/underfit)
:::
...
[Item 9 ger information närmare populationens nivå — och en extra svarströskel (t2).]{style="font-size:0.8em"}
